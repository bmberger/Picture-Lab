/*
 * Purpose: Displays a picture and lets you explore the picture by displaying the row, column, red,
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    Picture p = new Picture("whiteFlower.jpg");
    Picture smallP = p.scale(0.25, 0.25);
    smallP.write("smallWhiteFlower.jpg");
    smallP.explore();
  }  
